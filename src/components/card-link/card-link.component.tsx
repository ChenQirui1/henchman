...
const CardLink = ({ name, link, desc }) => {
  return (
    <div className="m-1 mb-1 p-6 max-w-fit bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
